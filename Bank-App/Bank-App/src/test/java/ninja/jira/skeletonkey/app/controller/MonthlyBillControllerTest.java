...
public class MonthlyBillControllerTest {
    ...
    /**
     * This method tests if a valid monthly bill can be retrieved by bill ID
     * @throws Exception
     */
    @Test
    public void getMonthlyBillPositive() throws Exception {
    ...
    /**
     * This method tests if a monthly bill belonging to an invalid bill ID
     * @throws Exception
     */
    @Test
    public void getMonthlyBillNegative() throws Exception {
        mockMvc.perform(get("/api/monthlybill/get")
                .param("billID", "2"))
                .andDo(print())
                .andExpect(status().isBadRequest())
    ...
    /**
     * This method tests if a valid monthly bill can be retrieved by valid account
     * @throws Exception
     */
    @Test
    public void getMonthlyBillByCardPositive() throws Exception {
        mockMvc.perform(get("/api/monthlybill/card")
    ...
    /**
     * This method tests if a monthly bill belonging to an invalid account
     * @throws Exception
     */
    @Test
